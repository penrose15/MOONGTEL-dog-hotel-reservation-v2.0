...
public class WithMockCustomCompanySecurityContextFactory implements WithSecurityContextFactory<WithAuthCompany> {
    @Override
    public SecurityContext createSecurityContext(WithAuthCompany annotation) {
