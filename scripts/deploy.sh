...
echo "nohup java -jar -Dspring.config.location=src/main/resources/${real},/home/ec2-user/app/application-db.yml /home/ec2-user/reservation/reservation-0.0.1-SNAPSHOT.jar > /dev/null 2>&1 &"
java -jar \
